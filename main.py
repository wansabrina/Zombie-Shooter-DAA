...
BackGround = Background('asset/background.png', [0,0])
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        height = 150
        sheet = pygame.image.load('asset/player.png').convert_alpha()      # convert_alpha so the backround is transparent
        ...
        sprite_sheet = SpriteSheet('asset/player.png')
...
class Zombie(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.sheet = pygame.image.load('asset/zombie.png').convert_alpha()          # so the backround is transparent
        ...
        self.sprite_sheet = SpriteSheet('asset/zombie.png')         #intializing the sprite sheet class
...
class Blood(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        pygame.sprite.Sprite.__init__(self)
        blood_image = pygame.image.load('asset/blood.gif').convert_alpha()  # so the background is transparent
...
def gameover_screen():
    screen.fill(BLACK)
    draw_text(screen, 'Zombie Shooter', 64, WIDTH/2, HEIGHT/4)
